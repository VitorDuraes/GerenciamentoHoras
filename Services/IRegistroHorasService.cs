...
namespace GerenciamentoHoras.Services
{
    public interface IRegistroHorasService
    {
        ...
        Task<IEnumerable<RegistroHoras>> GetRelatorioAsync(string? matricula = null, string? projeto = null, TipoRegistro? tipo = null, DateTime? dataInicio = null, DateTime? dataFim = null);
        Task<Dictionary<TipoRegistro, decimal>> GetTotalHorasPorTipoAsync(string? matricula = null, string? projeto = null, DateTime? dataInicio = null, DateTime? dataFim = null);
    }
}
